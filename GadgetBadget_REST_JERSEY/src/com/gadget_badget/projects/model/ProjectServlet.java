...
public class ProjectServlet 
{
	...
	{ 
		...
		String header = "<nav class='navbar navbar-inverse'>"
			...
			+ "<li class='dropdown'><a class='dropdown-toggle' data-toggle='dropdown' href='#'>Category<span class='caret'></span></a>"
			+ "<ul class='dropdown-menu'>"
			+ "<li><a href='myService/Projects/onlyDetails'>UI Design</a></li>"
			+ "<li><a href='myService/Projects/onlyDetails'>Back End</a></li>"
			+ "<li><a href='myService/Projects/onlyDetails'>UI/UX</a></li>"
			+ "</ul>"
			+ "</li>"
			+ ""
